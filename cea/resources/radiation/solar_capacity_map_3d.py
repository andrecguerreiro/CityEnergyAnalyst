    ...
    for feature in features:
        ...
        for ring_index, ring in enumerate(rings):
            ...
            if points_wgs84[0] != points_wgs84[-1]:
                points_wgs84.append(points_wgs84[0])

            roof_name = roof_id if roof_id else str(ring_index + 1)
            z_vals = [pt[2] for pt in points_wgs84]
            roofs.append(
                {
                    "building": building,
                    "roof_id": roof_name,
                    "polygon_abs": points_wgs84,
...
<body>
  ...
  <script>
    ...
    function buildLayers() {{
      ...
      return [geojsonLayer, customRoofLayer, customRoofEdgeLayer, barsLayer];
    }}
