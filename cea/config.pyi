...
class Configuration:
    ...
    @overload
    def __getattr__(self, item: Literal["ucea"]) -> UceaSection: ...
    @overload
...
class UceaSection(Section):
    ...
    @overload
    def __getattr__(self, item: Literal["weather_source"]) -> str: ...
    @overload
    ...
    @overload
    def __getattr__(self, item: Literal["polygon_timeout_minutes"]) -> float: ...
    @overload
    def __getattr__(self, item: Literal["open_browser"]) -> bool: ...
    @overload
    def __getattr__(self, item: Literal["geojson_url"]) -> Any: ...
    def __getattr__(self, item: str) -> Any: ...
